/* Floating "Chat on WhatsApp" button, bottom-right of every page.
   Opens a WhatsApp chat with the Jurisbooks number, with a greeting already typed
   that mentions the page the visitor is on (Offline / Online / general). */
(function () {
  var NUMBER = '919220499490';
  ...
  ready(function () {
    ...
    a.setAttribute('aria-label', 'Chat with us on WhatsApp'); a.title = 'Chat with us on WhatsApp';
